/* HID Usage ID ==> X68kキーコード への変換テーブル【NUM キー有効時】*/

#ifndef FN_KEYCODE
#define FN_KEYCODE 0x75
#endif

const uint8_t keytable_num[] PROGMEM = {
    0x00,   // 00h  []
    0x00,   // 01h  []
    0x00,   // 02h  []
    0x00,   // 03h  []
    ...
    0x71,   // 39h  Caps   ==> 0x71 CTRL / 0x5d Caps
    0x63,   // 3Ah  F1
    0x64,   // 3Bh  F2
    0x65,   // 3Ch  F3
    0x66,   // 3Dh  F4
    ...
    0x3e,   // 51h  DOWN
    0x3c,   // 52h  UP
    0x3f,   // 53h  NumLock    ==> 0x3f CLR / 0x74 NUM
    0x40,   // 54h  Num /      ==> 0x40 / 0x5c コード入力
    0x41,   // 55h  Num *      ==> 0x41 / 0x52 記号入力
    0x42,   // 56h  Num -      ==> 0x42 / 0x53 登録 
    0x46,   // 57h  Num +      ==> 0x46 / 0x4a Num =
    0x4e,   // 58h  Num Enter
    0x4b,   // 59h  Num 1
    0x4c,   // 5Ah  Num 2
    0x4d,   // 5Bh  Num 3
    ...
    0x45,   // 61h  Num 9
    0x4f,   // 62h  Num 0
    0x51,   // 63h  Num .      ==> 0x51 Num . / 0x50 Num ,
    0x00,   // 64h  []
    0x72,   // 65h  APP    ==> OPT.1
    0x00,   // 66h  []
    0x4a,   // 67h  Num =
